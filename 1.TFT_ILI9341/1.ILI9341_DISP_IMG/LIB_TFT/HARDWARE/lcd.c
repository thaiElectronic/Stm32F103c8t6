...
void LCD_GPIOInit(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_9| GPIO_Pin_8| GPIO_Pin_12; //GPIOB9,10,11,12
...
//	LCD_direction(USE_HORIZONTAL); // chieu man hinh: ngang
  LCD_direction(USE_STRAIGHT); // chieu man hinh: doc
	LCD_LED=1;//点亮背光	
