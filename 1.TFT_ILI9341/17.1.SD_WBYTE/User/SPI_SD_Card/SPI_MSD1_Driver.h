...
#define MSD1_card_enable()      	GPIOA->BRR = GPIO_Pin_4 //GPIO_ResetBits(GPIOB,GPIO_Pin_12)
#define MSD1_card_disable()     	GPIOA->BSRR = GPIO_Pin_4 //GPIO_SetBits(GPIOB,GPIO_Pin_12)
