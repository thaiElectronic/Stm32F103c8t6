...
#define MSD1_card_enable()      	GPIOB->BRR = GPIO_Pin_8 //GPIO_ResetBits(GPIOB,GPIO_Pin_12)
#define MSD1_card_disable()     	GPIOB->BSRR = GPIO_Pin_8 //GPIO_SetBits(GPIOB,GPIO_Pin_12)
