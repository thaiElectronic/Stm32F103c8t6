...
#define MSD0_card_enable()      	GPIOB->BRR = GPIO_Pin_7//GPIO_ResetBits(GPIOA,GPIO_Pin_7)
#define MSD0_card_disable()     	GPIOB->BSRR = GPIO_Pin_7//GPIO_SetBits(GPIOA,GPIO_Pin_7)
