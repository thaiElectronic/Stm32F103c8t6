...
void MFRC522_Init(void) {
	SPIx_Init(SPI2,SPI_BaudRatePrescaler_8);
...
uint8_t MFRC522_SPI_Transfer(u8 data)
{
...
void MFRC522_WriteRegister(uint8_t addr, uint8_t val) {
	...
	MFRC522_CS_LOW;
	//Send address
	MFRC522_SPI_Transfer((addr << 1) & 0x7E);
	//Send data	
	MFRC522_SPI_Transfer(val);
	//CS high
	MFRC522_CS_HIGH;
}
...
uint8_t MFRC522_ReadRegister(uint8_t addr) {
	...
	MFRC522_SPI_Transfer(((addr << 1) & 0x7E) | 0x80);	
	val = MFRC522_SPI_Transfer(MFRC522_DUMMY);
	//CS high
	MFRC522_CS_HIGH;
