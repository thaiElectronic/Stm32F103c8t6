...
//与触摸屏芯片连接引脚	   
//与触摸屏芯片连接引脚	   
#define PEN  PCin(4)    //PC10  INT
#define DOUT PCin(6)     //PC2  MISO		 PC2--PB14
#define TDIN PCout(7)    //PC3  MOSI		 PC3--PB15
#define TCLK PCout(5)    //PC0  SCLK	 PC0--PB13
#define TCS  PCout(1)   //PC13 CS    
